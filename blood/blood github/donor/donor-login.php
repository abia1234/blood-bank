...
<body>
    ...
    <form action="" method="post"> 
        ...
        <input type="password" name="ps" id="pasword" placeholder="Password"><br>
        <input type="submit" value="login" name="sub">
    </form> 
    Does not have an account ? <a href="donor-red.html">Click here to register</a>
-->
                    ...
                    <form action="dlogin.php" method="post">
                        <div class="form-body">
                            <div class="in">
                                ...
                                <input type="text"  name="un" id="username" required autofocus placeholder="Username"
                                    class="in-sty">
                            </div>
                            <div class="in">
                                <label for="password" style="font-size: 18px">Password</label>
                                <input type="password" name="ps" id="password" required placeholder="Password" class="in-sty">
                            </div>

                            <div style=" margin-left: 17px;
                height: 26px;">
                                  <button type="submit" name="login"  class="btn btn--radius-2 btn-danger"    style="width: 94px;
