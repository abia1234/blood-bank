  ...
  <div class="side-bar">
    ...
    margin-top: 50px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="blood-request.html" class="nav-link text-white">
            <i class="fas fa-hand-holding-heart"></i>&nbsp;&nbsp;Blood Request
          </a>
        </li>
        <li>
          <a href="request-history.html" class="nav-link text-white">
    ...
    <div class="row">
        <div class="col">
            <input type="text" class="in-sty" name="user_id" placeholder="Enter User ID" required>
        </div>
        <div class="col">
            <button type="submit" name="sub" class="btn btn-primary">Get Details</button>
        </div>
    </div>
</form>
        <table class="table table-bordered"
          ...
          <thead class="table-dark">
            <tr>
              <th scope="col" style="text-align:center;">Donor Age</th>
